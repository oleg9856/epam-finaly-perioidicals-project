...
<body class="sign error-page-wrapper background-color background-image">
	<div class="sign-container">
		...
		<div class="pane">
			<div class="headline sign-text-color">503</div>
	...
	<div class="text-container">
		<div class="headline secondary-text-color">503</div>
		<div class="context primary-text-color">

			<p>Go back to the previous page and try again. If you think
				something is broken, report a problem.</p>


		</div>
		<div class="buttons-container">
			<a class="border-button" href="mailto:#" target="_blank"><span
