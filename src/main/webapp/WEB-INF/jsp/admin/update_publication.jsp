...
<fmt:bundle basename="localization.local" prefix="publication_form.">
    <fmt:message key="title_update" var="title"/>
    <fmt:message key="main_header_update" var="main_header"/>
...
<div class="container-fluid" style="margin-top: 60px">
    <div class="row">
        ...
        <main role="main" class="col-md-9 m-lg-auto col-lg-10 px-4">
            ...
            <form action="${contextPath}/controller/admin/update-publication" method="post" enctype='multipart/form-data'>

                <div class="input-group mb-2">
                    <div class="input-group">
                        <label class="input-group-text" for="theme">${theme_select}:</label>
                    </div>
                    <input type="hidden" name="id" id="id" value="${publication_id}"/>
