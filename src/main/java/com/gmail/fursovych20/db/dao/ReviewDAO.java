...
public interface ReviewDAO {
	...
	/**
	 * A method that {@code review} by {@code publicationId}
	 *
	...
	/**
	 * A method that {@code create} review by {@code publicationId}
	 *
	...
	/**
	 * A method to {@code update} an existing {@code review} by {@code review entity}
	 *
	 * @param review parameter which provide data for create
	 * @return boolean true, or false dependency of parameters
	 * @throws DAOException throws an exception
	...
	/**
	 * A method to {@code delete} an existing {@code review} by {@code id}
	 *
	...
	/**
	 * A method to {@code read} an existing {@code review} by {@code id}
	 *
