...
import static com.gmail.fursovych20.web.util.WebConstantDeclaration.REQUEST_PARAM_SUBSCRIPTION_ID_OF_PUBLICATION;
...
public class EditPublicationCommandTest {
    ...
    public void testSuccessExecute() throws CommandExeption {
        ...
        when(request.getParameter(REQUEST_PARAM_SUBSCRIPTION_ID_OF_PUBLICATION)).thenReturn(ID);
        assertNotNull(editPublicationCommand.execute(request, response));
    }
}