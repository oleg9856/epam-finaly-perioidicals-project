...
public class UserSubscriptionHistoryCommandTest {
    ...
    @InjectMocks
    private UserSubscriptionHistoryCommand userSubscriptionHistoryCommand;
    ...
    public void testSuccessExecute() throws CommandExeption {
        ...
        when(session.getAttribute(SESSION_ATTR_USER_ID)).thenReturn(USER_ID);
        assertNotNull(userSubscriptionHistoryCommand.execute(request, response));
    }
}