...
public class GetAddPublicationFormCommandTest {
    ...
    @InjectMocks
    private GetAddPublicationFormCommand getAddPublicationFormCommand;

    @Test
    public void testSuccessExecute() throws CommandExeption {
        when(request.getSession()).thenReturn(session);
        assertNotNull(getAddPublicationFormCommand.execute(request,response));
    }
}